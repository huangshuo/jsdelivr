! function () {
  ...
  if (e = null !== t.getAttribute("mobile") ? {
    ...
    }, "false" === e.mobile && /Android|webOS|iPhone|iPod|iPad|BlackBerry/i.test(navigator.userAgent)) return;
  let n = 0;
  document.body.addEventListener("click", (function (t) {
    ...
    window.requestAnimationFrame((function t() {
      r--, d -= .02, i.style.top = r + "px", i.style.opacity = d, (new Date).getTime() - l < 600 ? window.requestAnimationFrame(t) : i.remove()
    }))
  }))
}();